...
export function Dashboard() {
  ...
  const [mainView, setMainView] = useState<"search" | "saved" | "chat">("search");
      ...
      <div className="flex-1 flex flex-col h-screen overflow-hidden">
        ...
        <div className="flex items-center gap-6 h-16 px-6 border-b border-border shrink-0">
          ...
          <div className="relative">
            ...
            {menuOpen && (
              <div className="absolute right-0 top-full mt-2 w-44 rounded-xl border border-border bg-card shadow-lg p-1 z-10">
                <button
                  type="button"
                  onClick={() => { setMenuOpen(false); navigate("/?edit=preferences"); }}
